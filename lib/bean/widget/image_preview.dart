  ...
  static Future<void> show(
    ...
    final effectiveHeroTag = heroTag ??
        (imageUrls.length > 1
            ...
            : imageUrls[index]);
    // 导航统一带尾斜杠（路由规范 A3）；routePath 仅作注册路径常量。
...
class _ImageViewerState extends State<ImageViewer> {
  ...
  Widget _buildNavButton({
    ...
    return Container(
      decoration: BoxDecoration(
        color: MediaChromeColors.scrim.withValues(alpha: 0.5),
      ...
      child: IconButton(
        ...
        icon: Icon(
          icon,
          color: onPressed != null ? MediaChromeColors.foreground : MediaChromeColors.foregroundDisabled,
          size: 32,
        ),
      ),
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: MediaChromeColors.surface,
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: IconButton(
                ...
                icon: const Icon(Icons.close, color: MediaChromeColors.foreground),
              ),
            ),
          ),
          if (_isMultiImage)
              ...
              child: Center(
                child: Container(
                  ...
                  child: Text(
                    ...
                    style: const TextStyle(color: MediaChromeColors.foreground, fontSize: 14),
                  ),
                ),
              ),
            ),
    ...
    return Listener(
      ...
      child: GestureDetector(
        ...
        child: PhotoView(
          ...
          backgroundDecoration: const BoxDecoration(color: MediaChromeColors.surface),

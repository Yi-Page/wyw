...
Future<T?> showAdaptiveBottomSheet<T>({
  ...
  // 复用 WywDialog.showBottomSheet 统一走 observer 追踪的 route（name 为
  // 'WywBottomSheet'），避免自适应 sheet 绕过 WywDialogObserver 而无法被 dismiss。
  return WywDialog.showBottomSheet<T>(
    context: context,
    builder: builder,

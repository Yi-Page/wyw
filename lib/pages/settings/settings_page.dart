...
import '../../bean/appbar/app_bar_menu_button.dart';
...
/// 只保留本应用实际提供页面的设置项。
/// 弹幕相关设置（SettingGroup.danmaku）尚无对应页面，暂不在此列出。
  ...
  _SettingsGroup(
    ...
    categories: [
      _SettingsCategory(
        ...
        builder: (_) => const PluginManagerPage(),
      ),
      _SettingsCategory(
        id: 'download',
        label: '下载设置',
        description: '并发数与下载路径',
  ...
  _SettingsGroup(
    ...
    categories: [
      _SettingsCategory(
        id: 'comicReader',
        label: '漫画阅读器设置',
        description: '阅读模式、翻页与缩放',
        icon: Icons.auto_stories_rounded,
        builder: (_) => const ComicReaderSettingsPage(),
      ),
    ],
  ),
  _SettingsGroup(
  ...
  Widget _listScaffold(
    ...
    return Scaffold(
      appBar: SysAppBar(
        ...
        actions: [const WywAppBarMenuButton(pagePath: '/settings/'),]
      ),
      body: SafeArea(
        top: false,
        child: Row(

enum SuperResolutionMode {
  ...
  /// Cycle to the next super-resolution mode (wraps).
  static SuperResolutionMode next(SuperResolutionMode current) {
    final values = SuperResolutionMode.values;
    final i = values.indexOf(current);
    return values[(i + 1) % values.length];
  }

  /// Convenience for UI labels.
  static String labelOf(SuperResolutionMode mode) => mode.label;
}

/// Player-facing alias used in the facade.
typedef PlayerSuperResolution = SuperResolutionMode;

...
/// Rounded tonal card for one download record: cover, title,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Wrap(
                          ...
                          children: [
                            _SourceTag(label: record.pluginName),
                            Text(
                              meta,
...
class DownloadEpisodeTile extends StatelessWidget {
  ...
  /// 集数显示名：`线路名 · 集名`（线路名/集名缺失时回退到反解集号）。
  String _episodeLabel() {
    final epIdx = episodeIndexOf(episode.episodeNumber) + 1;
    final name =
        episode.episodeName.isNotEmpty ? episode.episodeName : '第$epIdx集';
    if (episode.sourceName.isNotEmpty) {
      return '${episode.sourceName} · $name';
    }
    return name;
  }
